...
public class SetEmcScreen extends Screen {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        // 面板背景：深色半透明 + 边框
        DrawableHelper.fill(matrices, panelLeft, panelTop, panelLeft + PANEL_WIDTH, panelBottom, 0xC0101010);
        GuiRenderUtil.drawBorder(matrices, panelLeft, panelTop, PANEL_WIDTH, panelHeight, 0xFF404040);
        ...
        drawItemIcon(matrices, targetStack, itemIconX, itemY - 4);
        this.textRenderer.drawWithShadow(matrices,  targetStack.getName(),
                itemIconX + 20, itemY, 0xFFFFFF);
        Text idText = Text.literal(itemId).formatted(Formatting.GRAY);
        this.textRenderer.drawWithShadow(matrices,  idText,
                itemIconX + 20, itemY + 10, 0xA0A0A0);
