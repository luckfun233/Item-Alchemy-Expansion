...
/**
 * NBT 指纹生成器：把 {@link ComponentNbtView} 收集的 NbtCompound 压缩为规范化 SNBT 字符串。
 *
 ...
 * 通过 {@link StringNbtReader} 反解析回 {@link NbtCompound}，从而在提取槽重建带组件的 ItemStack。</p>
 *
...
public final class NbtFingerprinter {
     ...
     * @param nbt   已由 {@link ComponentNbtView#collectEffectiveNbt} 收集的 NbtCompound
